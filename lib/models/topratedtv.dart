...
class TopRatedTvShowsModel {
    ...
    factory TopRatedTvShowsModel.fromRawJson(String str) => TopRatedTvShowsModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory TopRatedTvShowsModel.fromJson(Map<String, dynamic> json) => TopRatedTvShowsModel(
        page: json["page"],
